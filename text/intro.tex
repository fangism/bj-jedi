...
In this variation, the dealer must hit on a 
soft-17 (A,6)\index{hit on soft-17}.
Later, we will compare the edge impact of this variation
vs. the dealer standing on soft-17\index{stand on soft-17}.

In this table, the transition edges for A$\rightarrow$10
...
By the state-transition process defined in the table,
...
This state-transition process is also known as a 
