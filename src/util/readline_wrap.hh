...
// can't just use auto_ptr, which does delete
...
//	typedef	excl_malloc_ptr<char_type>::type	get_line_type;
	typedef	char_type*				get_line_type;
#ifdef	USE_HISTEDIT
	/**
...
//	typedef	excl_malloc_ptr<const_char_type>::type	hold_line_type;
	typedef	const_char_type*			hold_line_type;
#endif
#ifdef	USE_HISTEDIT
...
typedef	char** (*completion_function_ptr)(const char*, int, int);
