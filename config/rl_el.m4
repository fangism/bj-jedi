...
dnl Readline and Editline support for the utility library used by this project.
dnl

dnl @synopsis FANG_ARG_WITH_NCURSES
dnl
...
dnl
AC_DEFUN([FANG_ARG_WITH_NCURSES],
...
AC_REQUIRE([FANG_ARG_WITH_NCURSES])
...
dnl AC_REQUIRE([FANG_ANAL_COMPILE_FLAGS])
...
CXXFLAGS="$save_CXXFLAGS -W -Wall -Werror"
	AC_COMPILE_IFELSE(
	AC_LANG_PROGRAM([
	#include <cstdio>
